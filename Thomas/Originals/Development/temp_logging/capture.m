...
t_curvefit_start = 1e-3;    % reject time in s
...
%channelSettings(1).analogueOffset = -0.21;
...
save(savefile, 'buffer_a_mv', 'buffer_a_mv_mean', 'timeIntNs1', 'decay_ms', 'standd');
